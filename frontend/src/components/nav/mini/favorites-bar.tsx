			...
			{favorites.length > 0 && (
				<HoverCard openDelay={100}>
					<HoverCardTrigger asChild>
						<div
							className={cn(
								"inline-flex w-full items-center justify-center rounded-md px-2 py-1.5 text-sm transition-all duration-300 ease-in-out cursor-pointer",
						...
						>
							...
							>
								...
								<span className="text-xs mt-1">{t("sys.menu.favorites")}</span>
							</div>
						</div>
					</HoverCardTrigger>
