...
const ApiPage = lazy(() => import("@/pages/management/system/api"));
const DictionaryPage = lazy(() => import("@/pages/management/system/dictionary"));
		...
		children: [
			...
			},
			{
				...
				children: [
					...
					{
						path: "external-link",
						element: <ExternalLink src="https://ant.design/index-cn" />,
					},
				],
			},
